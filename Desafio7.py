...
# Solicitando os valores de entrada com explicações
capital = float(input(" Digite o valor do capital (C) em R$: "))
taxa = float(input(" Digite o valor da taxa de juros (I) em %: "))
unidade = input(" Escolha a unidade de tempo (horas, dias ou meses): ").strip().lower()
...
if unidade == "horas":
    ...
    print(" Unidade de tempo inválida. Por favor, escolha entre horas, dias ou meses.")
    exit()
